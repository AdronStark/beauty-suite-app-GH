...
export default function DatabaseClientsView() {
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                <div>
                    <h1 style={{ fontSize: '1.8rem', fontWeight: 700, color: '#1e293b', display: 'flex', alignItems: 'center', gap: '10px' }}>
                        <Building2 size={32} className="text-primary" /> Ficha de Clientes
                    </h1>
                    <p style={{ color: '#64748b' }}>Base de datos centralizada de clientes y gestión de entidades.</p>
                </div>
                <button
                    onClick={openCreate}
                    style={{
